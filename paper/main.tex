...
All pairs show substantial CKA improvement after alignment, confirming that the framework is model-agnostic. Cross-modality CKA improvement scales with the initial alignment: pairs with higher initial CKA (ESM1b+NT-v2) achieve higher post-alignment CKA.
